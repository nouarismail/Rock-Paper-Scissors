        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameTransactions_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameTransactions_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Player1Move = table.Column<int>(type: "integer", nullable: false),
                    Player2Move = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchHistories_AspNetUsers_Player1Id",
                        column: x => x.Player1Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchHistories_AspNetUsers_Player2Id",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "GameTransactions",
                column: "SenderId")
                .Annotation("Npgsql:IndexInclude", new[] { "ReceiverId", "TransactionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_GameTransactions_TransactionDate",
                table: "GameTransactions",
                column: "TransactionDate");

            migrationBuilder.CreateIndex(
                name: "IX_MatchHistories_MatchDate",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MatchHistories",
                column: "Player1Id")
                .Annotation("Npgsql:IndexInclude", new[] { "Player2Id", "MatchDate" });
